...
import { Text, Card, Flex, Tag, Heading, LinkExternal, IconButton, Button, DropDownBottomIcon } from '@crosswise/uikit'
...
export const BalanceText = styled(Text)<{ isZero?: boolean }>`
  font-weight: bold;
  font-size: 18px;
  ${({ theme }) =>
    theme.isDark
...
export const StyledCard = styled(Card)<{ index?: number }>`
  /* margin: 0 0 32px 0; */
  margin: 0;
  align-self: baseline;
  position: relative;
