...
import { LabelNameText, BalanceItem, BalanceText, VerticalDivider } from './styled'
...
const BalanceContainer: React.FC<BalanceContainerProps> = ({ farm, account }) => {
  ...
  const { stakedBalance: stakedBalanceAsString = 0, earnings: earningsAsString = 0 } = farm.userData || {}
  ...
  return (
    <>
      <BalanceItem>
        <Flex>
          <LabelNameText textTransform="uppercase" fontSize="16px" pr="4px" color={isDark ? '#04F8AD' : '#7a8596'}>
            XCRSS
          </LabelNameText>
          <LabelNameText fontSize="16px" color={isDark ? '#04F8AD' : '#7a8596'}>
            {t('Earned')}
          </LabelNameText>
        </Flex>
