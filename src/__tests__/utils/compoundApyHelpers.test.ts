import { tokenEarnedCompounding, getRoi } from 'utils/compoundApyHelpers'
...
it.each([
  ...
  expect(tokenEarnedCompounding({ balance: 1000, numberOfDays, farmApr, tokenPrice, performanceFee })).toEqual(expected)
})
