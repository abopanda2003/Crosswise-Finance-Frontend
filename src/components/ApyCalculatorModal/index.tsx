...
const ApyCalculatorModal: React.FC<ApyCalculatorModalProps> = ({
  ...
  return (
    <Modal title=" " onDismiss={onDismiss} width="346px" noPadding onClick={() => setPopupDescriptionVisible(false)}>
      <RoiModalHeader>
        <Text fontSize="18px" fontWeight="700" textTransform="uppercase" mr="12px" color="bluePalette.main">
          {t('ROI Calculator')}
        </Text>
        <CalculateIcon ml={3} color="bluePalette.main" />
      </RoiModalHeader>
      <RoiModalContainer>
