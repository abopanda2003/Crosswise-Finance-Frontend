...
import { useFarmUser, useFarmFromPid } from 'state/farms/hooks'
...
const Staked: React.FunctionComponent<StackedActionProps> = ({
  ...
  const { allowance, tokenBalance } = useFarmUser(pid)
  ...
  return (
    <ActionContainer>
      ...
      <ActionContent>
        <ActionButton width="100%" disabled={requestedApproval} onClick={handleApprove} variant="primaryGradient">
          {t('Enable')}
        </ActionButton>
      </ActionContent>
    </ActionContainer>
